...
(2, 'Perusahaan yang bergerak di bidang jasa pembuatan website dan aplikasi yang berbasis data lainnya.', 'Memberikan layanan yang terbaik kepada klien\r\nMengembangkan kerjasama dan kemitraan usaha yang saling menguntungkan\r\nMengembangkan inovasi teknologi terbaik dan terkini dalam setiap produk\r\nMeningkatkan benefit dan nilai tambah bagi klien dan stake holder tujuan\r\nMendapatkan keuntungan dan kemitraan usaha yang sinergi dan berkelanjutan', 'Screenshot (10).png');
...
(2, 'https://facebook.com/citra', 'https://instagram.com/citra', '09877886668', 'Jakartassss');
