...
<head>
    <meta charset="utf-8">
    <title>Newsers | Citra Febriawirti</title>
...
<body>
    ...
    <div class="mb-5" style="margin-bottom: 200px;">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
        <a href="https://api.whatsapp.com/send?phone=6283161854892&text=Haiiiiii Selamat Datang 😍." class="float"
            target="_blank">
                    ...
                    <div class="top-info flex-grow-0">
                        ...
                        <div class="overflow-hidden" style="width: 735px;">
                            <div id="note" class="ps-2">
                                ...
                                <a href="#">
                                    <p class="text-white mb-0 link-hover">"Dapatkan informasi terbaru di sini, baca
                                        berita terupdate sekarang!".</p>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                        <!-- <?php
                        // Mendapatkan nilai 'page' dari URL, jika tidak ada maka default adalah 'index'
                        $page = isset($_GET['page']) ? $_GET['page'] : 'index';
                        ?> -->
                        <div class="navbar-nav mx-auto border-top">
                            <a href="index.php"
                                class="nav-item nav-link <?php echo $page == 'index' ? 'active' : ''; ?>">Beranda</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                  ...
                                  ?>
                                    <a href="index.php?nama_kategori=<?=$k['nama_kategori']?>"
                            ...
                            <a href="?page=about"
                                class="nav-item nav-link <?php echo $page == 'about' ? 'active' : ''; ?>">Tentang</a>
                            <a href="?page=tim"
                                class="nav-item nav-link <?php echo $page == 'tim' ? 'active' : ''; ?>">Tim</a>
                            <a href="?page=kontak"
                        ...
                        <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0">
                            <div class="d-flex">
                                <i class="fas fa-calendar-alt fa-2x me-1 mt-2 " style="opacity: 0.5;"></i>
                                <div class="d-flex align-items-center">

                                    <div class="d-flex flex-column ms-2" style="width: 150px;">
                                        <strong class="text-body"><?=date("l")?>,</strong>
                ...
                <form action="index.php" method="POST">
                    <div class="modal-body d-flex align-items-center">
                        ...
                        <div class="input-group w-100 mx-auto d-flex">
                            ...
                            <button id="search-icon-1" class="input-group-text p-3 " name="cari" type="submit"><i
