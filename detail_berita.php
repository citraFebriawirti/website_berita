...
<div class="container-fluid py-5">
    <div class="container py-5">
        <ol class="breadcrumb justify-content-start mb-4">
            ...
            <li class="breadcrumb-item active text-dark">Detail Berita</li>
        </ol>
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="mb-4">
                ...
                <div class="position-relative rounded overflow-hidden mb-3">
                    <img src="admin/berita/uploads/<?= $d['gambar_berita'] ?>"
                ...
                <div class="d-flex justify-content-between">
                    <a href="#" class="text-dark link-hover me-3"><i class="fa fa-clock"></i> <?=$d['tgl_berita']?></a>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="#"
                                        ...
                                        <span class="text-white"><?= $data['no_telp'] ?></span>
                                    </a>
                                    <a href="#"
                                        ...
                                        <span class="text-white"><?= $data['alamat'] ?></span>
                                    </a>
                                </div>
                                <?php } ?>
                            </div>
